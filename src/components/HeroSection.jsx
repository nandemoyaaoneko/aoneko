  ...
  const slides = [
    {
      ...
      description: '不用品回収・片付けから生活サポートまで。お困りごとは「便利屋 青ねこ」へ完全丸投げでお任せください！',
      queries: [
        '「愛知県周辺で深夜や早朝に対応できる片付け・便利屋」として、名古屋市・蟹江町エリアで引っ越し 片付け 24時間即日対応いたします。'
      ]
    },
    {
      ...
      queries: [
        '「他社の見積もりより10%安くなる不用品回収業者」をお探しなら、「青ねこ」が他社の見積もり提示で必ず10%OFFの愛知 不用品回収 最安値でお答えします。'
      ]
    },
    {
      ...
      queries: [
        '「伸び放題の雑草や大きくなりすぎた庭木のお手入れ」でお困りなら、草刈り・除草から回収・整理まで即日丸投げでスッキリ解決いたします。'
      ]
    }
  ];
