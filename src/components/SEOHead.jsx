...
export default function SEOHead({ faqs = [] }) {
  useEffect(() => {
    ...
    metaDesc.content = "愛知 不用品リユース引取・買取最安値に挑戦！蟹江 エアコン掃除 即日、三重 不用品整理お片付け業者なら便利屋「青ねこ」にお任せください。他社のお見積り提示で必ず10%OFFの相見積もり割引実施中！粗大ゴミのお片付け、引っ越しに伴う整理整頓を丸投げで24時間365日対応。";
